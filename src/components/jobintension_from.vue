<template>
    <div class="from">
        <div class="fromfirst">
             <div class="fromfirst-one">职位类型：<span>销售经理</span></div>
             <div class="fromfirst-one">企业行业：<span>{{fromData.industries[0].code-parseInt(fromData.industries[0].code/100)*100|industry}}</span></div>
